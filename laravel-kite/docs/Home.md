...
```
composer install abenevaut/laravel-kite
```

Add Providers `bootstrap/providers.php`
...
You can remove from `config/auth.php` if you don't overload it.
Or adjust like following
...
```php
    ...
    */
    ...
    'providers' => [
        'users' => [
            'driver' => 'eloquent',
            'model' => env('AUTH_MODEL', App\Domain\Users\Users\User::class),
        ],
    ],
